    ...
    return (
      <button key={soldier.id} type="button"
        ...
        <div className="flex items-center gap-1 shrink-0 flex-wrap justify-end">
          ...
          {isConcurrent && (
            <span className="text-[10px] font-semibold px-1 py-0.5 rounded-full text-orange-700 bg-orange-50">
              ב.ז
            </span>
          )}
          <span className={`text-[10px] font-semibold px-1 py-0.5 rounded-full ${status.color}`}>
            {status.label}
          </span>
